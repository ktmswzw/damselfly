package com.damselfly.common.session;
 ...
 * @author vincent
 */
public class OpenworkShiroSessionDAO extends AbstractSessionDAO {
    ...
    public void delete(Session session) {
        ...
        // if session is too large,when session destory clear shiro cache
    }
