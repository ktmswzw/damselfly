...
// Fonts
var NORMAL_FONT = {font: "10px Microsoft YaHei", opacity: 1, fill: Color.black};
var LABEL_FONT = {font: "11px Microsoft YaHei", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR};
var LABEL_FONT_SMOOTH = {font: "10px Microsoft YaHei", "font-style":"italic", opacity: 1, "fill": LABEL_COLOR, stroke: LABEL_COLOR, "stroke-width":.4};
var TASK_FONT = {font: "11px Microsoft YaHei", opacity: 1, fill: Color.black};
var TASK_FONT_SMOOTH = {font: "11px Microsoft YaHei", opacity: 1, fill: Color.black, stroke: LABEL_COLOR, "stroke-width":.4};
var POOL_LANE_FONT = {font: "11px Microsoft YaHei", opacity: 1, fill: Color.black};
var EXPANDED_SUBPROCESS_FONT = {font: "11px Microsoft YaHei", opacity: 1, fill: Color.black};
...
// var DefaultProcessDiagramCanvas = {
    ...
    init: function(width, height, processDefinitionId){
        ...
        //this.setFont("Microsoft YaHei", 11);
        this.setFont(NORMAL_FONT);
        //this.font = this.g.getFont("Microsoft YaHei");
...
// TODO: generate polylineId or do something!!
    ...
    fitTextToWidth: function(original, width) {
        ...
        var attr = {font: "11px Microsoft YaHei", opacity: 0};
    ...
    _drawMultilineText: function(text, x, y, boxWidth, boxHeight, verticalAlign, horizontalAlign) {
        ...
        //var font = {font: "11px Microsoft YaHei", opacity: 1, "fill": LABEL_COLOR};
