		...
		Tree.prototype = {
			...
			selectItem: function selectItem( el ) {
				...
				if ( this.options.multiSelect ) {
					...
					$all.removeClass( 'tree-selected' ).find( '.glyphicon' ).removeClass( 'glyphicon-ok' );
					$all.find( '.icon-item' ).addClass( 'fueluxicon-bullet' );

					//$all.removeClass( 'tree-selected' ).find( '.glyphicon' ).removeClass( 'glyphicon-ok' ).addClass( 'fueluxicon-bullet' );
					data.push( selData );
				}
